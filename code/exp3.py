...
if not os.path.exists("../results/synth_results/exp3/"):
      os.makedirs("../results/synth_results/exp3/")
...
for seed in [0,1,2,3,4]:
      ...
      df.to_csv("../results/synth_results/exp3/exp3_diffnaps_%d.csv"%seed,index=False)
      dfs.append(df)
mean_dfs(dfs, "exp3", "exp3_diffnaps")